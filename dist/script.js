...
/*#__PURE__*/
function () {
  function Accordion(triggers, text) {
    ...
    value: function init() {
      ...
      this.triggers.forEach(function (item) {
        item.addEventListener('click', function () {
          _this.text.forEach(function (item) {
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function checkMailInputs() {
      var mailInputs = document.querySelectorAll('input[type="email"]');
    ...
    value: function bindForm() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          message.textContent = _this.status.loading;
          form.append(message);
          var formData = new FormData(form);

          _this.postData('assets/question.php', formData).then(function (res) {
            console.log(res);
            message.textContent = _this.status.success;
          }).catch(function () {
            message.textContent = _this.status.failure;
          }).finally(function () {
            _this.clearInputs();
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            ...
            if (document.querySelector('iframe#frame')) {
              ...
              _this.path = btn.getAttribute('data-url'); // console.log(this.path);
